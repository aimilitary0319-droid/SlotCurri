...
def main():
    ...
    runs = [
        ...
        (
            ...
            str(root / "logs/_ytvis_attnmass_v7/checkpoints/slotcurri_step=step=80000.ckpt"),
        ),
    ]
    if not args.skip_v8:
        runs.append(
            (
                ...
                str(root / "logs/_ytvis_attnmass_v8/checkpoints/slotcurri_step=step=81000.ckpt"),
            )
        )
